<?php
//Include Common Files @1-E66E057F
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "inventorycatego_maint.php");
...
class clsRecordinventorycategory { //inventorycategory Class @2-EB1A06C3
...
//Class_Initialize Event @2-7BC6C354
    function clsRecordinventorycategory($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record inventorycategory/Error";
        ...
        if($this->Visible)
        {
            ...
            $this->InventoryCategory1 = new clsControl(ccsTextBox, "InventoryCategory1", "Inventory Category", ccsText, "", CCGetRequestParam("InventoryCategory1", $Method, NULL), $this);
            $this->InventoryCategory1->Required = true;
...
//Validate Method @2-0D4858E3
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
        $Where = "";
        $Validation = ($this->InventoryCategory1->Validate() && $Validation);
        $Validation = ($this->IsActive->Validate() && $Validation);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        $Validation =  $Validation && ($this->InventoryCategory1->Errors->Count() == 0);
        $Validation =  $Validation && ($this->IsActive->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @2-0B1ACF7A
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->InventoryCategory1->Errors->Count());
...
//Operation Method @2-0E03A45A
    function Operation()
    {
        ...
        $Redirect = "inventorycatego_maint.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//InsertRow Method @2-361F3CF5
    function InsertRow()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeInsert", $this);
        if(!$this->InsertAllowed) return false;
        $this->DataSource->InventoryCategory1->SetValue($this->InventoryCategory1->GetValue(true));
...
//Show Method @2-A68A03F6
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            $Error = "";
            $Error = ComposeStrings($Error, $this->InventoryCategory1->Errors->ToString());
...
} //End inventorycategory Class @2-FCB6E20C

class clsinventorycategoryDataSource extends clsDBFuelSaver {  //inventorycategoryDataSource Class @2-F27B7E22

//DataSource Variables @2-1DCDC1F5
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-688FA7EE
...
//Insert Method @2-F70DC418
    function Insert()
    {
        ...
        $this->InsertFields["InventoryCategory"]["Value"] = $this->InventoryCategory1->GetDBValue(true);
...
//Update Method @2-8EBD7861
    function Update()
    {
        ...
        $this->UpdateFields["InventoryCategory"]["Value"] = $this->InventoryCategory1->GetDBValue(true);
...
} //End inventorycategoryDataSource Class @2-FCB6E20C

//Include Page implementation @15-A6D0C5B5
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "inventorycatego_maint.html";
$BlockToParse = "main";
...
$inventorycategory = new clsRecordinventorycategory("", $MainPage);
...
$Content->AddComponent("inventorycategory", $inventorycategory);
...
//Execute Components @1-C9878CB6
$MasterPage->Operations();
$headerIncludablePage->Operations();
$MenuIncludablePage->Operations();
$inventorycategory->Operation();
//End Execute Components

//Go to destination page @1-9BB5C9E1
if($Redirect)
{
