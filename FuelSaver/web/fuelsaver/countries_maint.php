...
class clsRecordcountries { //countries Class @2-D7FE4C24
...
//Class_Initialize Event @2-6D4CC53D
    function clsRecordcountries($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record countries/Error";
...
//Operation Method @2-9CC8A019
    function Operation()
    {
        ...
        $Redirect = "countries_maint.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
} //End countries Class @2-FCB6E20C

class clscountriesDataSource extends clsDBFuelSaver {  //countriesDataSource Class @2-5D64D42D

//DataSource Variables @2-787A561B
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-06267143
...
} //End countriesDataSource Class @2-FCB6E20C
...
$countries = new clsRecordcountries("", $MainPage);
...
$Content->AddComponent("countries", $countries);
...
//Go to destination page @1-D175B519
if($Redirect)
{
