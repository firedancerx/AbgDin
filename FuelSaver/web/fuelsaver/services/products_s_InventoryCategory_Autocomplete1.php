<?php
//Include Common Files @1-EB778BBF
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "products_s_InventoryCategory_Autocomplete1.php");
...
//Class_Initialize Event @2-E27C0CBE
...
//DataSource Variables @2-6CDDCBD8
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-0942EAC5
...
//Prepare Method @2-C9DF6D01
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "InventoryCategory", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-A8549EE4
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM productlist";
        $this->SQL = "SELECT InventoryCategory \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "products_s_InventoryCategory_Autocomplete1.html";
$BlockToParse = "main";
