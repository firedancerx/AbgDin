<?php
//Include Common Files @1-536FA187
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "products_s_InventoryDescription_Autocomplete1.php");
...
//Class_Initialize Event @2-B53277D9
...
//DataSource Variables @2-73196E12
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-464AD5F2
...
//Prepare Method @2-38E0420A
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "InventoryDescription", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-84A2F956
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM productlist";
        $this->SQL = "SELECT InventoryDescription \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "products_s_InventoryDescription_Autocomplete1.html";
$BlockToParse = "main";
