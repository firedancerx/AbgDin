<?php
//Include Common Files @1-A7BC4D77
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "products_s_Id_Autocomplete1.php");
...
//Class_Initialize Event @2-697277CA
...
//DataSource Variables @2-0250745A
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-5796813C
...
//Prepare Method @2-02EFC7E2
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "Id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-949077ED
    function Open()
    {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "products_s_Id_Autocomplete1.html";
$BlockToParse = "main";
