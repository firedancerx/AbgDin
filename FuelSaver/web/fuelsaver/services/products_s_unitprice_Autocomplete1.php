<?php
//Include Common Files @1-14FDC8CC
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "products_s_unitprice_Autocomplete1.php");
...
//Class_Initialize Event @2-77CF7C2D
...
//DataSource Variables @2-DDABCCE3
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-EF4F2ABA
...
//Prepare Method @2-CF80E0F5
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlterm", ccsSingle, "", "", $this->Parameters["urlterm"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "unitprice", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsSingle),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-11373373
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM productlist";
        $this->SQL = "SELECT unitprice \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "products_s_unitprice_Autocomplete1.html";
$BlockToParse = "main";
