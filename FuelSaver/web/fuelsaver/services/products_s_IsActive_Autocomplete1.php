<?php
//Include Common Files @1-67F4E1F6
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "products_s_IsActive_Autocomplete1.php");
...
//Class_Initialize Event @2-D2459333
...
//DataSource Variables @2-DB8B41F0
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-6ED0406B
...
//Prepare Method @2-AE5FFF0F
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "IsActive", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-403784BA
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM productlist";
        $this->SQL = "SELECT IsActive \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "products_s_IsActive_Autocomplete1.html";
$BlockToParse = "main";
