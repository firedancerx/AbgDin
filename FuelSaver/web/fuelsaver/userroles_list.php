<?php
//Include Common Files @1-4E662E1D
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "userroles_list.php");
...
class clsGriduserroles { //userroles class @6-ACB3F9D5

//Variables @6-ED8E1C38
...
//Class_Initialize Event @6-C137F1BD
    function clsGriduserroles($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->ErrorBlock = "Grid userroles";
        ...
        $this->SorterName = CCGetParam("userrolesOrder", "");
        $this->SorterDirection = CCGetParam("userrolesDir", "");

        $this->Id = new clsControl(ccsLink, "Id", "Id", ccsInteger, "", CCGetRequestParam("Id", ccsGet, NULL), $this);
        $this->Id->Page = "userroles_maint.php";
        ...
        $this->userroles_Insert = new clsControl(ccsLink, "userroles_Insert", "userroles_Insert", ccsText, "", CCGetRequestParam("userroles_Insert", ccsGet, NULL), $this);
        $this->userroles_Insert->Parameters = CCGetQueryString("QueryString", array("Id", "ccsForm"));
        $this->userroles_Insert->Page = "userroles_maint.php";
...
} //End userroles Class @6-FCB6E20C

class clsuserrolesDataSource extends clsDBFuelSaver {  //userrolesDataSource Class @6-E1B07A92

//DataSource Variables @6-6ECE3746
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @6-9BFF04DC
...
//Prepare Method @6-8625721F
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urls_UserRole", ccsText, "", "", $this->Parameters["urls_UserRole"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opContains, "UserRole", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @6-E89A59CE
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM userroles";
        $this->SQL = "SELECT Id, UserRole, IsActive \n\n" .
...
} //End userrolesDataSource Class @6-FCB6E20C

class clsRecorduserrolesSearch { //userrolesSearch Class @2-2FB65784
...
//Class_Initialize Event @2-C09465FF
    function clsRecorduserrolesSearch($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record userrolesSearch/Error";
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "userrolesSearch";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
            ...
            $this->s_UserRole = new clsControl(ccsTextBox, "s_UserRole", "User Role", ccsText, "", CCGetRequestParam("s_UserRole", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Validate Method @2-C9B80DAE
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//Operation Method @2-ED831423
    function Operation()
    {
        ...
        $Redirect = "userroles_list.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "userroles_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
} //End userrolesSearch Class @2-FCB6E20C

//Include Page implementation @28-A6D0C5B5
include_once(RelativePath . "/menuincludablepage.php");
//End Include Page implementation

//Include Page implementation @29-C1F5F4D3
include_once(RelativePath . "/headerIncludablePage.php");
//End Include Page implementation

//Initialize Page @1-A68C4496
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "userroles_list.html";
$BlockToParse = "main";
...
//Include events file @1-C948148E
include_once("./userroles_list_events.php");
...
$userroles = new clsGriduserroles("", $MainPage);
$userrolesSearch = new clsRecorduserrolesSearch("", $MainPage);
...
$MainPage->userrolesSearch = & $userrolesSearch;
$MainPage->Menu = & $Menu;
...
$Content->AddComponent("userrolesSearch", $userrolesSearch);
...
//Execute Components @1-6EECF772
$MasterPage->Operations();
$headerIncludablePage->Operations();
$MenuIncludablePage->Operations();
$userrolesSearch->Operation();
//End Execute Components

//Go to destination page @1-92DC35D4
if($Redirect)
{
