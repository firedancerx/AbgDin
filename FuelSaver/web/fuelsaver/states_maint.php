<?php
//Include Common Files @1-745B52A1
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "states_maint.php");
...
class clsRecordstates { //states Class @2-B60F730B
...
//Class_Initialize Event @2-BC419543
    function clsRecordstates($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record states/Error";
...
} //End states Class @2-FCB6E20C

class clsstatesDataSource extends clsDBFuelSaver {  //statesDataSource Class @2-73A109D5

//DataSource Variables @2-2583BADC
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-CB5FE4DE
...
} //End statesDataSource Class @2-FCB6E20C

//Include Page implementation @17-A6D0C5B5
include_once(RelativePath . "/menuincludablepage.php");
//End Include Page implementation

//Include Page implementation @18-C1F5F4D3
include_once(RelativePath . "/headerIncludablePage.php");
//End Include Page implementation

//Initialize Page @1-049C3A18
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "states_maint.html";
$BlockToParse = "main";
...
$states = new clsRecordstates("", $MainPage);
...
//Go to destination page @1-E014F434
if($Redirect)
{
